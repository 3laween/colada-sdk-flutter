...
class NativeDeferredDeepLink {
  ...
  static NativeDeferredDeepLink decode(Object result) {
    ...
    return NativeDeferredDeepLink(
      ...
      menuItemId: result[1] as String?,
      isCoffeeSubscription: result[2]! as bool,
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(storeId, other.storeId) &&
        _deepEquals(menuItemId, other.menuItemId) &&
        _deepEquals(isCoffeeSubscription, other.isCoffeeSubscription) &&
